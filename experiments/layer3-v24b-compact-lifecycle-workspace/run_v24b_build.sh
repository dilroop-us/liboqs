...
BUILD="$ROOT/build-v24b-compact-lifecycle-workspace"
...
echo
echo "Built v24b compact lifecycle workspace:"
...
echo
echo "Flag check:"
grep -R "MLD_CONFIG_EXPERIMENTAL_COMPACT_LIFECYCLE_WORKSPACE" "$BUILD/compile_commands.json" | head
