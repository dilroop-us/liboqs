...
OUT = ROOT / "layer3-results/v27_mlkem_targets.md"

PREVIOUS = {
    ("x86_64", "indcpa_keypair_derand"): 10336,
    ("ref", "indcpa_keypair_derand"): 10336,
...
md = "# v27 target ML-KEM stack frames\n\n"
md += "| Variant | Function | Previous stack | v27 stack | Reduction |\n"
md += "|---|---|---:|---:|---:|\n"
...
md += "\n## Interpretation\n\n"
md += (
    "v27 moves the large `indcpa_keypair_derand` local buffers out of the stack "
    "and into explicit caller-provided workspace.\n\n"
)

md += (
    "`indcpa_enc` should remain reduced from v26. `indcpa_dec` is intentionally "
    "unchanged and remains the target for v28.\n"
)
