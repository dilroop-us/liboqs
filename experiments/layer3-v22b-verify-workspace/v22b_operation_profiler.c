...
extern size_t PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v22b_verify_workspace_bytes(void)
    __attribute__((weak));
extern int PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v22b_verify_workspace_set(void *workspace,
                                                                       size_t workspace_bytes)
    __attribute__((weak));
extern size_t PQCP_MLDSA_NATIVE_MLDSA44_C_v22b_verify_workspace_bytes(void)
    __attribute__((weak));
extern int PQCP_MLDSA_NATIVE_MLDSA44_C_v22b_verify_workspace_set(void *workspace,
                                                                 size_t workspace_bytes)
    __attribute__((weak));
...
static void setup_v22b_verify_workspace_if_available(void) {
  if (PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v22b_verify_workspace_bytes &&
    ...
    if (v22b_x86_verify_workspace == NULL ||
        PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v22b_verify_workspace_set(
            v22b_x86_verify_workspace, bytes) != 0) {
  ...
  if (PQCP_MLDSA_NATIVE_MLDSA44_C_v22b_verify_workspace_bytes &&
    ...
    if (v22b_c_verify_workspace == NULL ||
        PQCP_MLDSA_NATIVE_MLDSA44_C_v22b_verify_workspace_set(
            v22b_c_verify_workspace, bytes) != 0) {
...
static void run_sig_sign(size_t iterations) {
  ...
  printf("Layer 3 v22b verify workspace profiler\n");
