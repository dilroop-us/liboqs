...
size_t PQCP_MLKEM_NATIVE_MLKEM768_X86_64_v26_enc_workspace_bytes(void) {
    return sizeof(mlk_v26_enc_workspace);
}

int PQCP_MLKEM_NATIVE_MLKEM768_X86_64_v26_enc_workspace_set(void *workspace, size_t workspace_bytes) {
