...
size_t PQCP_MLKEM_NATIVE_MLKEM768_C_v27_keypair_workspace_bytes(void) {
    return sizeof(mlk_v27_keypair_workspace);
}

int PQCP_MLKEM_NATIVE_MLKEM768_C_v27_keypair_workspace_set(void *workspace, size_t workspace_bytes) {
...
size_t PQCP_MLKEM_NATIVE_MLKEM768_C_v28_dec_workspace_bytes(void) {
    return sizeof(mlk_v28_dec_workspace);
}

int PQCP_MLKEM_NATIVE_MLKEM768_C_v28_dec_workspace_set(void *workspace, size_t workspace_bytes) {
...
size_t PQCP_MLKEM_NATIVE_MLKEM768_C_v29_lifecycle_workspace_bytes(void) {
    return sizeof(mlk_v29_lifecycle_workspace);
}

int PQCP_MLKEM_NATIVE_MLKEM768_C_v29_lifecycle_workspace_set(void *workspace, size_t workspace_bytes) {
