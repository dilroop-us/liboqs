...
size_t PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v17b_sign_workspace_bytes(void) {
  return sizeof(mld_v17b_sign_workspace);
}

int PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v17b_sign_workspace_set(void *workspace, size_t workspace_bytes) {
  if (workspace == 0) {
...
size_t PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v16_matrix_workspace_bytes(void) {
  return sizeof(mld_v16_matrix_workspace);
}

int PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v16_matrix_workspace_set(void *workspace, size_t workspace_bytes) {
  if (workspace == 0) {
...
size_t PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v19b_attempt_workspace_bytes(void) {
  return sizeof(mld_v19b_attempt_workspace);
}

int PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v19b_attempt_workspace_set(void *workspace, size_t workspace_bytes) {
...
size_t PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v21_sign_workspace_bytes(void) {
...
int PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v21_sign_workspace_set(void *workspace, size_t workspace_bytes) {
  const size_t sign_bytes = sizeof(mld_v17b_sign_workspace);
  const size_t sign_aligned = mld_v21_align_up(sign_bytes, MLD_V21_WORKSPACE_ALIGN);
  const size_t total_bytes = PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v21_sign_workspace_bytes();
  uintptr_t base;
...
size_t PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v22b_verify_workspace_bytes(void) {
  return sizeof(mld_v22b_verify_workspace);
}

int PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v22b_verify_workspace_set(void *workspace, size_t workspace_bytes) {
...
size_t PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v24_lifecycle_workspace_bytes(void) {
...
int PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v24_lifecycle_workspace_set(void *workspace,
   ...
   */
  rc = PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v21_sign_workspace_set(workspace, workspace_bytes);
  if (rc != 0) {
    return -3;
  }
   ...
   */
  rc = PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v22b_verify_workspace_set((void *)op_base, op_union_bytes);
  if (rc != 0) {
    return -4;
  }
   ...
   */
  rc = PQCP_MLDSA_NATIVE_MLDSA44_X86_64_v23b_keygen_workspace_set((void *)op_base, op_union_bytes);
  if (rc != 0) {
    return -5;
  }
                                ...
                                MLD_CONFIG_CONTEXT_PARAMETER_TYPE context)
{
  ...
  MLD_V17B_ALLOC_MAT(mat);
  MLD_V17B_ALLOC_S1HAT(s1hat);
  MLD_V17B_ALLOC_T0HAT(t0hat);
  MLD_V17B_ALLOC_S2HAT(s2hat);
...
cleanup:
  ...
  /* @[FIPS204, Section 3.6.3] Destruction of intermediate values. */
  MLD_V17B_FREE_S2HAT(s2hat);
  MLD_V17B_FREE_T0HAT(t0hat);
  MLD_V17B_FREE_S1HAT(s1hat);
  MLD_V17B_FREE_MAT(mat);
