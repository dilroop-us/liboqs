...
int PQCP_MLDSA_NATIVE_MLDSA44_C_v17b_sign_workspace_set(void *workspace, size_t workspace_bytes) {
  if (workspace == 0) {
...
size_t PQCP_MLDSA_NATIVE_MLDSA44_C_v23b_keygen_workspace_bytes(void) {
  return sizeof(mld_v23b_keygen_workspace);
}

int PQCP_MLDSA_NATIVE_MLDSA44_C_v23b_keygen_workspace_set(void *workspace, size_t workspace_bytes) {
...
size_t PQCP_MLDSA_NATIVE_MLDSA44_C_v21_sign_workspace_bytes(void) {
...
int PQCP_MLDSA_NATIVE_MLDSA44_C_v21_sign_workspace_set(void *workspace, size_t workspace_bytes) {
  const size_t sign_bytes = sizeof(mld_v17b_sign_workspace);
  const size_t sign_aligned = mld_v21_align_up(sign_bytes, MLD_V21_WORKSPACE_ALIGN);
  const size_t total_bytes = PQCP_MLDSA_NATIVE_MLDSA44_C_v21_sign_workspace_bytes();
  uintptr_t base;
...
size_t PQCP_MLDSA_NATIVE_MLDSA44_C_v22b_verify_workspace_bytes(void) {
  return sizeof(mld_v22b_verify_workspace);
}

int PQCP_MLDSA_NATIVE_MLDSA44_C_v22b_verify_workspace_set(void *workspace, size_t workspace_bytes) {
...
size_t PQCP_MLDSA_NATIVE_MLDSA44_C_v24_lifecycle_workspace_bytes(void) {
...
int PQCP_MLDSA_NATIVE_MLDSA44_C_v24_lifecycle_workspace_set(void *workspace,
   ...
   */
  rc = PQCP_MLDSA_NATIVE_MLDSA44_C_v21_sign_workspace_set(workspace, workspace_bytes);
  if (rc != 0) {
    return -3;
  }
   ...
   */
  rc = PQCP_MLDSA_NATIVE_MLDSA44_C_v22b_verify_workspace_set((void *)op_base, op_union_bytes);
  if (rc != 0) {
    return -4;
  }
   ...
   */
  rc = PQCP_MLDSA_NATIVE_MLDSA44_C_v23b_keygen_workspace_set((void *)op_base, op_union_bytes);
  if (rc != 0) {
    return -5;
  }
